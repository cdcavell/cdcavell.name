...
|-------|------|-------------|
| 1.0.3.3 | 03/08/2021 | __Update:__ User Authorization Web Service <br /> Dependency update <br />&nbsp;&nbsp;&nbsp;&nbsp;_Duende.IdentityServer v5.0.5_ <br />&nbsp;&nbsp;&nbsp;&nbsp;_Duende.IdentityServer.Storage v5.0.5_ <br />&nbsp;&nbsp;&nbsp;&nbsp;_Duende.IdentityServer.AspNetIdentity v5.0.5_ |
