...
namespace as_api_cdcavell.Controllers
{
    ...
    /// </revision>
    public class AllPermissionsController : ApplicationBaseController<AllPermissionsController>
    {
        /// <summary>
        /// Constructor method
        /// </summary>
        /// <param name="logger">ILogger&lt;AllPermissionsController&gt;</param>
        ...
        /// <method>
        /// public AllPermissionsController(
        ///     ILogger&lt;AllPermissionsController&gt; logger,
