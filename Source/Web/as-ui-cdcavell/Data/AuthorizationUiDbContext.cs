...
namespace as_ui_cdcavell.Data
{
    ...
    public class AuthorizationUiDbContext : DbContext
    {
        ...
        public AuthorizationUiDbContext(ILogger<AuthorizationUiDbContext> logger, IHttpContextAccessor httpContextAccessor, DbContextOptions<AuthorizationUiDbContext> options)
            : base(options)
        {
